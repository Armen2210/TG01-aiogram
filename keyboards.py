...
#     return keyboard.adjust(2).as_markup() # 'adjust(2)' - количество кнопок в ряду
# # Метод as_markup() преобразует клавиатуру так, чтобы Телеграм мог использовать эту клавиатуру для отправки сообщений
